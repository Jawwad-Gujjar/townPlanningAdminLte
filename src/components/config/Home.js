...
//             <img src="dist/img/tp.png" alt="AdminLTE Logo" className="brand-image img-circle elevation-3" style={{opacity: '.8'}} />
//             <span className="brand-text font-weight-light">TOWN PLANNING</span>
//           </a>
//           {/* Sidebar */}
...
//                 </li> */}
//                 <li className="nav-item">
//   <Link to="/area" className="nav-link" style={{color:'whitesmoke' ,fontSize:12}} > 
...
//   </li>
//   <li className="nav-item">
//   <Link to="/installment" className="nav-link" style={{color:'whitesmoke',fontSize:12}}>
//   {/* <i className="nav-icon fas fa-area-chart" /> */}
//      <p>
//      INSTALLMENT
//      </p>
...
//   </li>
//   <li className="nav-item">
//   <Link to="/location" className="nav-link" style={{color:'whitesmoke', fontSize:12}}>
...
//   </li>
//   <li className="nav-item">
//   <Link to="/locationtype" className="nav-link" style={{color:'whitesmoke' , fontSize:12}}>
//   <i className="nav-icon fas fa-map-marker" />
//      <p>
//      LOCATION TYPE
//      </p>
    ...
    return (
      <div  className="wrapper" >
        ...
        <aside className="main-sidebar sidebar-dark-primary elevation-4">
          ...
          <a href="index3.html" className="brand-link">
            <img src="dist/img/tp.png" alt="AdminLTE Logo" className="brand-image img-circle elevation-3" style={{opacity: '.8'}} />
            <span className="brand-text font-weight-light" style={{fontStyle:"italic"}}>TOWN PLANNING</span>
          </a>
          {/* Sidebar */}
          <div className="sidebar">
            {/* Sidebar user panel (optional) */}
            ...
            <nav className="mt-2">
              ...
              <li className="nav-header">SETUP</li>
                <li className="nav-item">
                  ...
                  <ul className="nav nav-treeview">
                                        <li className="nav-item">
                    <Link to="/area" className="nav-link" style={{color:'whitesmoke' ,fontSize:15}} > 
                      <i className="nav-icon fas fa-area-chart" />
                     <p>
                        AREA
                     </p>
                    ...
                    <li className="nav-item">
                  <Link to="/location" className="nav-link" style={{color:'whitesmoke', fontSize:15}}>
                     <i className="nav-icon fas fa-map-marker" />
                     <p>
                        LOCATION
                     </p>
              ...
              <li className="nav-item">
              <Link to="/locationtype" className="nav-link" style={{color:'whitesmoke' , fontSize:15}}>
              ...
              <li className="nav-item">
                   <Link to="/installment" className="nav-link" style={{color:'whitesmoke',fontSize:15}}>
                       <i className="nav-icon fab fa-instalod" />
                     <p>
                        INSTALLMENT
                     </p>
                   </Link>
              ...
              <li className="nav-item">
              <Link to="/payment" className="nav-link" style={{color:'whitesmoke', fontSize:15 }}>
              ...
              <li className="nav-item">
              <Link  to="/policy" className="nav-link" style={{color:'whitesmoke' , fontSize:15}}>
              ...
              <li className="nav-item">
              <Link to="/allotment" className="nav-link" style={{color:'whitesmoke' ,fontSize:15}}>
              ...
              <li className="nav-item">
              <Link to="/receipt" className="nav-link" style={{color:'whitesmoke' ,fontSize:15}}>
              <i className="nav-icon fas fa-receipt" />
               ...
               <li className="nav-header">REGISTERATION</li>
               <li className="nav-item">
               <Link to="/booking" className="nav-link" style={{color:'whitesmoke' ,fontSize:15}}>
               ...
               <li className="nav-item">
              <Link to="/customer" className="nav-link" style={{color:'whitesmoke' , fontSize:15}}>
              ...
              <li className="nav-header">BROKER REGISTERATION</li>
              <li className="nav-item">
              <Link to="/broker" className="nav-link" style={{color:'whitesmoke' ,fontSize:15}}>
                       <i className="nav-icon fas fa-user" />
                     <p>
                   BROKER INFORMATION
                     </p>
              ...
              <li className="nav-header">PROJECT INFORMATION</li>
              <li className="nav-item">
              <Link to="/projectdetail" className="nav-link" style={{color:'whitesmoke' , fontSize:15}}>
              ...
              <li className="nav-item">
              <Link  to="/locdtl" className="nav-link" style={{color:'whitesmoke' , fontSize:15}}>
